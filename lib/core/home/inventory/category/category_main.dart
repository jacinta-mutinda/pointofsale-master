                      ...
                      children: [
                        ...
                        smallPriBtn(
                            ...
                            function: () {
                              ...
                              invtCtrl.fieldsCatRequired.value = false;
                              Get.to(const CategoryForm());
                            }),
                      ])),
              Obx(() => invtCtrl.showCatLoading.value
                  ? loadingWidget(label: 'Loading categories ...')
                              ...
                              Obx(
                                () => ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      var categories = invtCtrl.rangeCatList;
                                      return Padding(
                                              ...
                                              child: ListTile(
                                                ...
                                                trailing: Container(
                                                    ...
                                                    child: const Icon(
                                                        ...
                                                        color: Colors.white)),
                                                onTap: () async {
                                                  invtCtrl.isCatEdit.value =
                                                      true;
                                                  invtCtrl.fieldsCatRequired
                                                      .value = false;
